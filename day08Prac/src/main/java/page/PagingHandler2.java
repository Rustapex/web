...
public class PagingHandler2 {
	...
	public PagingHandler2(int pageSize, int grpSize, int totRecords, int currentPage) {
	...
	public static void main(String[] args) {
		...
		PagingHandler2   handler  = new PagingHandler2(5, 4, 46, 5);
